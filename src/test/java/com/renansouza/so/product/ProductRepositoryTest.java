...
class ProductRepositoryTest {
    ...
    void findByTypeIgnoreCase() {
        ...
        assertThat(repository.findByTypeIgnoreCase(actual.getType())).isPresent();
    ...
    void existsClientByNameIgnoreCase() {
        assertThat(repository.findAll()).isEmpty();
        repository.save(product);
        assertThat(repository.existsProductByDescriptionIgnoreCase(java.util.Optional.of(product.getDescription()))).isNotNull();
    }
    ...
    void existsFindByNameIgnoreCase() {
        assertThat(repository.findAll()).isEmpty();
        repository.save(product);
        assertThat(repository.existsProductById(1)).isNotNull();
    }
